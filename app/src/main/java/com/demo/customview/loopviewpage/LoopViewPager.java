...
import com.demo.customview.loopviewpage.anim.AnimStyle;
import com.demo.customview.loopviewpage.anim.FixedSpeedScroller;
import com.demo.customview.loopviewpage.anim.transformer.AccordionTransformer;
import com.demo.customview.loopviewpage.anim.transformer.AccordionUpTransformer;
import com.demo.customview.loopviewpage.anim.transformer.CubeTransformer;
import com.demo.customview.loopviewpage.anim.transformer.CubeUpTransformer;
import com.demo.customview.loopviewpage.anim.transformer.DefaultTransformer;
import com.demo.customview.loopviewpage.anim.transformer.ZoomPageTransformer;
import com.demo.customview.loopviewpage.listener.OnCreateItemViewListener;
import com.demo.customview.loopviewpage.listener.OnItemClickListener;
    ...
    private void init() {
        ...
        switch (animStyle) {
            ...
            case AnimStyle.CUBE_UP:
                ...
                break;
            case AnimStyle.DEFAULT:
                transformer = new DefaultTransformer();
                break;
            case AnimStyle.GALLERY:
    ...
    private View getDefaultItemView(final int currentIndex) {
        ...
        if (view == null) {
            ...
            if (imgData instanceof List) {
                Glide.with(getContext()).load(String.valueOf(((List) imgData).get(currentIndex))).into((ImageView) view);
            } else if (imgData instanceof Integer[]) {
                Glide.with(getContext()).load(((Integer[]) imgData)[currentIndex]).into((ImageView) view);
            } else if (imgData instanceof String[]) {
                Glide.with(getContext()).load(((String[]) imgData)[currentIndex]).into((ImageView) view);
            }
...
//
//                    ToastUtils.showShortToast(context,"点击"+currentIndex);
//                }
//            });
...
//            throw new IllegalArgumentException();
    ...
    private String mVideoHead;
    private boolean mIsVideo = false;

    public void setVideoHead(String videoHead) {
        this.mVideoHead = videoHead;
    }
