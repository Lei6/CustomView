...
public class SortUtil {
    ...
    public void onScrolled(RecyclerView recyclerView, View layout, TextView tvLetter) {
        if (recyclerView == null || layout == null || tvLetter == null || mLetterMap == null || mData == null) {
            return;
        }
        ...
        int[] value = mLetterMap.get(mData.get(firstVisibleItemPosition).letter);
        int nextSectionPosition = value != null ? value[1] : -1;
        if (firstVisibleItemPosition != mLastFirstVisibleItem) {
            ViewGroup.MarginLayoutParams params = (ViewGroup.MarginLayoutParams) layout.getLayoutParams();
            params.topMargin = 0;
            layout.setLayoutParams(params);
            tvLetter.setText(mData.get(firstVisibleItemPosition).letter);
        }
