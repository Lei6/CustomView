...
/**
 * created by 姚明亮
 * Time：2019/8/17 16:34
 */
public class ToggleButton extends View implements IToggleView {
    ...
    public ToggleButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ui_view_ToggleButton);
        mColorThumb = typedArray.getColor(R.styleable.ui_view_ToggleButton_ui_view_colorThumb, ContextCompat.getColor(context, R.color.colorFFFFFF));
        mColorTrackOpen = typedArray.getColor(R.styleable.ui_view_ToggleButton_ui_view_colorTrackOpen, ContextCompat.getColor(context, R.color.colorF9F9F9));
        mColorTrackOff = typedArray.getColor(R.styleable.ui_view_ToggleButton_ui_view_colorTrackOff, ContextCompat.getColor(context, R.color.colorFFFFFF));
        mColorPadding = typedArray.getColor(R.styleable.ui_view_ToggleButton_ui_view_colorPadding, ContextCompat.getColor(context, R.color.colorE34E5));
        mPadding = (int) typedArray.getDimension(R.styleable.ui_view_ToggleButton_ui_view_padding, 1);
        mDuration = typedArray.getInteger(R.styleable.ui_view_ToggleButton_ui_view_duration, 0);
